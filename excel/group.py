...
for d in class_list:
    ...
    txt = '填报单位：'.decode('utf-8') + msg.split('_')[2] + ' '.decode('utf-8') + msg.split('_')[3] + '   时间：'.decode('utf-8')  + stime + '   乡村组编码：'.decode('utf-8') + d + '   填报人：'.decode('utf-8') + pp +'   审核人：'.decode('utf-8') + sh
    tmpSheet.write(1,0,txt)
    '''
